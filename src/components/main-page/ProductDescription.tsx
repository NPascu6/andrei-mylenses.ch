            ...
            <div className="p-2 rounded-md shadow-xl text-center card">
                ...
                <p className="text-xl font-bold">
                    ...
                    <span className="flex justify-center m-3 pointer">
                        <a href="https://thelensofandrei.picfair.com" rel="noreferrer" target="_blank" className="flex justify-center ">
                            <img style={{ maxWidth: '25%' }} alt="picfair" src="https://logowik.com/content/uploads/images/picfair3077.logowik.com.webp" />
                        </a>
                    </span>
                </p>
