    ...
    return (
        <section id="top" className="mx-auto flex max-w-7xl scroll-mt-24 flex-col gap-2 px-4 pb-4 pt-1 md:px-6 md:scroll-mt-28">
            <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
                <article className="surface-panel relative overflow-hidden rounded-4xl">
                    <div className="absolute inset-x-0 top-0 h-40 bg-[radial-gradient(circle_at_top_left,rgba(var(--accent-color),0.22),transparent_60%)]"/>
                    <div className="relative space-y-7 p-6 md:p-8">
                        <div className="grid gap-5 md:grid-cols-[auto_minmax(0,1fr)] md:items-center">
                            ...
                            <div className="min-w-0 space-y-4 text-center md:space-y-5 md:text-left">
                                ...
                                <h1 className="font-display mx-auto max-w-[7.1ch] text-[clamp(2.35rem,12vw,4.65rem)] leading-[0.9] tracking-[-0.03em] text-appText wrap-anywhere text-balance sm:max-w-[7.8ch] md:mx-0 md:max-w-[8.3ch] md:text-[clamp(3.15rem,5.1vw,4.65rem)] xl:max-w-[8.8ch]">
                        ...
                        <div className="grid gap-3 sm:grid-cols-3">
                            {highlights.map((item) => (
                                <div
                                    key={item.label}
                                    className="surface-panel-soft rounded-3xl p-4"
                                >
                ...
                <button
                    ...
                    className="group relative min-h-[560px] overflow-hidden rounded-4xl border border-white/10 bg-black text-left shadow-2xl shadow-black/20"
                >
                    {heroPhoto && (
                        <>
                            <ExpandableImage
            ...
            <article
                id="story"
                className="surface-panel scroll-mt-24 rounded-4xl p-6 md:scroll-mt-28 md:p-8"
            >
